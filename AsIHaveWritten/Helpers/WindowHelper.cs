...
public class WindowHelper
{
    ...
    public (int x, int y, int w, int h) ToAbsolute(float fx, float fy, float fw, float fh, bool clientToScreen = true)
    {
    ...
    public Bitmap GetImage(float fx = 0, float fy = 0, float fw = 1, float fh = 1)
    {
